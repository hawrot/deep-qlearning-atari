...
Original file is located at
    https://colab.research.google.com/drive/1HYE49YXWbAojqbiAW9YUMSgjm94Y-2b3
"""
...
rew = []
while True or frame_count < 2000000:  # Run until solved
    ...
    if running_reward > 40 or frame_count > 2000000:  # Condition to consider the task solved
        rew = episode_reward_history
        import pandas as pd
        pd.DataFrame(rew).to_csv('/content/drive/MyDrive/ai games assignment/file.csv')
        print("Solved at episode {}!".format(episode_count))
        break

model.save('/content/drive/MyDrive/ai games assignment/model')
